...
- `2026-08-25-an-external-blocker-never-clears-even-when-its-target-is-completed.md`
...
The same defect was reported on GitHub as issue
[#28](https://github.com/brocef/TCW/issues/28), filed 2026-09-02 by
@brocef. That report is folded in here; it adds the cost to `tcw work
reconcile` and three candidate remediations. Its words, verbatim:

> ### Environment
>
> - tcw version: `tcw 1.2.2`
> - OS / platform: macOS 26.6.2
> - Install method: pyenv shim (pip)
>
> ### Steps to reproduce
>
...
> ```
>
> 1. Complete the referenced item (`proposit-shared/<referent-slug>`).
> 2. Try to start the dependent: `tcw work start <dependent-slug>` still refuses.
...
>
> ```
> tcw work edit <dependent-slug> --unblocked-by "external: <node>/<referent-slug>"
> ```
>
...
> 2. Keep `external:` but resolve any value matching `<known-node-id>/<slug>`, and report it as satisfied once complete.
