...
>
> ```
> docs/proposit-mobile/work/completed/<slug-a>/capabilities.yaml:5:    - shared/authoring/build-with-the-assistant
> docs/proposit-mobile/work/completed/<slug-b>/capabilities.yaml:18:   - shared/authoring/add-a-claim-to-a-premise
> ```
>
...
>
> Separately worth considering: whether `<unqualified-prefix>/…` should resolve when the prefix is an unambiguous suffix of exactly one connected node id (`shared/` → `proposit-shared`). Rejecting it is defensible; doing so silently at write time is what costs the time.
>
>
