...
lists. A real work target in the registered graph but outside the board being
served is marked as off-board and names its owning project; malformed, unknown,
unregistered, or dangling targets remain inert and state why. All
