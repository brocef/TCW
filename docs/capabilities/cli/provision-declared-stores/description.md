...
out never fetches from a remote its config chose until I run this command. A
failure — unreachable remote, unknown ref, refused authentication — tells me the
cause, exits non-zero, and leaves no half-fetched store behind.
