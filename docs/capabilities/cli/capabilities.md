...
As a user, I run `tcw init [taxonomy|capabilities|work]` inside a git repo to scaffold the `docs/<component>/` trees (all three by default). It refuses outside a git work-tree and reports each directory it created.
