...
capabilities I should mark `Omitted`. A bound ticket is moved to its discarded status whoever holds it, since abandoning
work needs no claim. A discarded item counts as resolved: it
