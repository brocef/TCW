...
Developer changelog for v0.14.0. Technical and precise; grouped by category,
...
<changes starting-hash="4f9eaf8" ending-hash="52adef3">
- Added and planned the backlog work item for a plugin-skill evaluation harness;
