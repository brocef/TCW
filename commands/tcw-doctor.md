...
the old clone means it skipped, and `pipx install --force "<active-clone>"` is then
the direct fix, but only once the install has been cleared as neither editable nor
unidentifiable.
