...
export function readThemePreference(storage: Pick<Storage, "getItem"> | null = window.localStorage): TThemePreference {
  try {
...
export function applyThemeAppearance(root: DOMTokenList, appearance: TThemeAppearance): void {
